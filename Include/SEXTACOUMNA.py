"""
normalizar_archivos_v28.py
───────────────────────────
• Igual a v27_fix2, pero añade la 6.ª columna-regla:
    terrenos_sin_unidades
    basada únicamente en NPNs coincidentes.
"""
...
for ruta, col_mat, desc in CRUDOS:
    ...
    # Procesamiento especial según columna
...
writer.close()
print("\n✅ MATRIZ_NPN.xlsx actualizado con la columna 'terrenos_sin_unidades' y resumen de 6 métricas.")
